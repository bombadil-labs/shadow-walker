...
export const inputs={
  ...
  prepare:{explorationId:id,selectedIds:z.array(id).min(1).max(4),humanDirection:text,lineId:id.optional(),gestureRequestId:id.optional(),requestId:id},
