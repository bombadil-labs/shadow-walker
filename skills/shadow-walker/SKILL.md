...
3. Call `prepare_move` for exactly one walk. Use the packet's original intention, frame, selected inputs, ordered paths, prior recorded waypoint, and reserves. Respect `maxMoves=1` and `maxPositions=2`.
